...
server = bluetooth.BluetoothSocket(bluetooth.RFCOMM)  # Creating Socket Bluetooth RFCOMM communication
...
try:
    ...
    while True:
        client.send("0")  # Sending the data.
        # data = client.recv(1024)            # Receiving the data. 1024 is the buffer size.
        # print(data)
